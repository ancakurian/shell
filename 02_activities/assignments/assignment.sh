...
touch ./02_activities/assignments/assignment.sh/dir2 file1.txt file2.txt file3.txt file4.txt file5.txt
# 4. Append the words "Hello world" to dir2/file3
echo "Hello world" >> ./02_activities/assignments/assignment.sh/dir2/file3.txt
# 5. Verify that file3 contains the words "hello world" by printing the contents of the file in the terminal
cat ./02_activities/assignments/assignment.sh/dir2/file3.txt
# 6. Delete file4
rm ./02_activities/assignments/assignment.sh/dir2/file4.txt
# 7. Delete directories dir4 and dir5 including all their contents (if any)
rm -r ./02_activities/assignments/assignment.sh/dir4 dir5 
